...
// darknet_ros_srv
#include <darknet_ros_msgs/DarknetSrv.h>
...
class YoloObjectDetectorSRV {
 public:
  /*!
   * Constructor.
   */
  explicit YoloObjectDetectorSRV(ros::NodeHandle nh);

  /*!
   * Destructor.
   */
  ~YoloObjectDetectorSRV();
 ...
 private:
  ...
  bool cameraCallbackSrv(darknet_ros_msgs::DarknetSrv::Request &req, darknet_ros_msgs::DarknetSrv::Response &res);
